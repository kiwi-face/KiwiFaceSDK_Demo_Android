...
public class kwStickerView extends FrameLayout implements StickerAdapter.IStickerHandler, StickerAdapter.onStickerChangeListener {
    ...
    public kwStickerView(Context context, AttributeSet attrs, int defStyle) {
